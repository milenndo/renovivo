  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Luxe custom colors
        luxe: {
          cream: "hsl(var(--luxe-cream))",
          taupe: "hsl(var(--luxe-taupe))",
          stone: "hsl(var(--luxe-stone))",
          charcoal: "hsl(var(--luxe-charcoal))",
          terracotta: "hsl(var(--luxe-terracotta))",
          caramel: "hsl(var(--luxe-caramel))",
      ...
      transitionTimingFunction: {
        ...
        'luxe-bounce': 'cubic-bezier(0.34, 1.56, 0.64, 1)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      boxShadow: {
        'luxe': '0 4px 30px -5px rgba(0, 0, 0, 0.1)',
        'luxe-lg': '0 10px 50px -10px rgba(0, 0, 0, 0.15)',
        'luxe-xl': '0 20px 80px -20px rgba(0, 0, 0, 0.2)',
        'inner-luxe': 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.05)',
      },
      backdropBlur: {
        'luxe': '20px',
      },
