          ...
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="text-3xl font-bold text-primary mb-6">от 180 до 280 лв./м²</div>
...
от 92 до 143 €/м² (180-280 лв./м²)
              <div className="bg-white rounded-lg shadow-lg p-8 ring-2 ring-primary transform md:scale-105">
                ...
                <div className="text-3xl font-bold text-primary mb-1">от 450 до 650 лв./м²</div>
...
от 230 до 332 €/м² (450-650 лв./м²)              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="text-3xl font-bold text-primary mb-6">от 650 до 900+ лв./м²</div>
                <Button className="w-full" variant="outline" asChild>
