...
const reasons = [
  {
    icon: User,
title: "Личен Управител на Проект",    description: "Един човек отговаря за целия обект и комуникацията. Край на Скролирайте за ощениректна връзка с отговорен мениджър.",
  },
  {
    icon: Calculator,
