...
export const projects: Project[] = [
  ...
  },
  {
    ...
    duration: "3 седмици",
    area: "60 кв.м.",
    description: "Довършителни работи на просторна дневна от 60 кв.м. в ново строителство. Пространството е оформено с елегантна мека мебел в неутрални тонове, акцентна стена с топла дървена текстура и минималистично обзавеждане, които създават усещане за простор и уют.",
